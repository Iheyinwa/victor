...
import threephotos from "../../../Assets/Images/first_middle_last.png"
    ...
    <Container>
      ...
      <Banner>
        ...
        <BannerAdd>
          <FirstText>
            <h6>
              Beauty procurement, <br /> simplified for you
            </h6>
          </FirstText>
          <SecondText>
            <p>
        ...
        <ProductDisplay>
          ...
          <FlexContainer>
            ...
            <MoreContainer onClick={() => navigate("/marketplace")}>
              <p>{isMobile ? "Shop more" : "See more"}</p>
              <RedRightArrow />
            </MoreContainer>
          </FlexContainer>
