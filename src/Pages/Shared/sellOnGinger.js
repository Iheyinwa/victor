    ...
    <Container>
      <Banner>
        ...
        <div>
          ...
          <h4>
            Leverage the opportunity to scale your business through ginger
          </h4>
        </div>
      </Banner>
      ...
      <GuideContainer>
        <h4>
          Easy guide to selling <br /> on ginger
        </h4>
        <Guide>
          <GuideActivities>
            <div>
          ...
          <GuideImage>
            <div>
              <img src="https://images.unsplash.com/photo-1518458028785-8fbcd101ebb9?q=80&w=3270&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" />
              <div>
                <div>
                  <LocationTag />
                  <div>
                    ...
                    <p>
                      ...
                      full user flows and interactive prototypes.
                    </p>
                  </div>
                </div>
              </div>
      ...
      <AccordionContainer>
        <h4>FAQ</h4>
        <Accordion title={"How to sell on ginger"} />
        <Accordion title={"Can i have multiple accounts"} />
        <Accordion title={"Is selling on ginger free"} />
        <Accordion title={"How do i create a seller store"} />
      </AccordionContainer>
